...
public class MainView extends FrameLayout {
  ...
  private void initialize(){
    ...
    mSplashView.setIconColor(Color.BLACK); // this is the Twitter blue color
    mSplashView.setIconResource(R.drawable.icon_black); // a Twitter icon with transparent hole in it
